package com.cc3389.igeekshop.util;
...
public class ValidationUtil {
    ...
    private static final String V_USERNAME="[A-Za-z0-9_\\-\\u4e00-\\u9fa5]{4,12}";
    ...
    /**验证密码*/
    private static final String V_PASSWORD_REG="^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,18}$";
